...
func fillTaskSettingsObj(settings TaskSettings, settingsObj *ole.IDispatch) error {
	...
	h.put(settingsObj, "ExecutionTimeLimit", settings.TimeLimit.String())
	...
	h.put(idlesettingsObj, "IdleDuration", settings.IdleSettings.IdleDuration.String())
	...
	h.put(idlesettingsObj, "WaitTimeout", settings.IdleSettings.WaitTimeout.String())
...
func fillTaskTriggersObj(triggers []Trigger, triggersObj *ole.IDispatch) error {
	for _, trigger := range triggers {
		...
		h.put(triggerObj, "ExecutionTimeLimit", trigger.GetExecutionTimeLimit().String())
		...
		h.put(repetitionObj, "Duration", trigger.GetRepetitionDuration().String())
		...
		case BootTrigger:
			...
			h.put(bootTriggerObj, "Delay", t.Delay.String())
		case DailyTrigger:
			...
			h.put(dailyTriggerObj, "RandomDelay", t.RandomDelay.String())
		case EventTrigger:
			...
			h.put(eventTriggerObj, "Delay", t.Delay.String())
		...
		case LogonTrigger:
			...
			h.put(logonTriggerObj, "Delay", t.Delay.String())
		...
		case MonthlyDOWTrigger:
			...
			h.put(monthlyDOWTriggerObj, "RandomDelay", t.RandomDelay.String())
		...
		case MonthlyTrigger:
			...
			h.put(monthlyTriggerObj, "RandomDelay", t.RandomDelay.String())
		...
		case RegistrationTrigger:
			...
			h.put(registrationTriggerObj, "Delay", t.Delay.String())
		case TimeTrigger:
			...
			h.put(timeTriggerObj, "RandomDelay", t.RandomDelay.String())
		case WeeklyTrigger:
			...
			h.put(weeklyTriggerObj, "RandomDelay", t.RandomDelay.String())
		...
		case SessionStateChangeTrigger:
			...
			h.put(sessionStateChangeTriggerObj, "Delay", t.Delay.String())
